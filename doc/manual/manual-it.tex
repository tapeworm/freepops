...
per mailbox col dominio \texttt{@yahoo.com.}
...
Questo plugin vi permette di leggere le mail che avete in una mailbox
\texttt{@yahoo.com}. Per usare questo plugin dovete usare il vostro
indirizzo email completo come username e la vostra password reale
come password.
...
per adattarlo al proprio sito. Per ora supporta solo la verisone 1.2
di squirrelmail.
