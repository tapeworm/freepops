...
extractor_function = function(file)
	...
	-- add parameters
	PLUGINS_PARAMETERS = PLUGINS_PARAMETERS or {}
	assert(	PLUGINS_PARAMETERS ~= nil and 
		type(PLUGINS_PARAMETERS == "table"),
		"PLUGINS_PARAMETERS must a be a list of strings")
	table.foreachi(PLUGINS_PARAMETERS,function(i,p)
		local name = p.name
...
extractor_function("src/lua/libero.lua")
